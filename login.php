        ...
        <div class="row justify-content-center mt-5"> 
          ...
          <div class="card-body p-5 text-center">
                <form action="loginAction.php" method="post" class="text-white" style="border-radius: 1rem">
                    ...
                    <button type="submit" class="btn btn-outline-light btn-lg px-5" ><a href="http://localhost/Groceryswap/home.php
                    " class="text-green-50 fw-bold">Login</a></button> 
                    <br> 

                    <br> <p  class="mb-0"> Don't Have Account?</p><a href="register.php"  class="text-white-50 fw-bold ">create now</a>
                    <br><br>
